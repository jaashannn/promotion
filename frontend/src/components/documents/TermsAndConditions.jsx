  ...
  const termsSections = [
    {
      ...
      content: `
        <ul class="space-y-2">
          <li><strong>Platform:</strong> Reflo Hub . is a software-as-a-service platform that helps enterprises and independent contractors connect worldwide.</li>
    ...
    },
    {
      ...
      content: `
        ...
        <p>To use Reflo Hub  services, users must first create an account.</p>
    ...
    },
    {
      ...
      content: `
        <h4 class="font-semibold">4.1. The function of Reflo Hub :</h4>
        <p>The sole mode of operation for Reflo Hub  is Software-as-a-Service (SaaS). Although we make it easier for leads to be submitted and exchanged, we have no control over any direct agreements or transactions between corporations and freelancers.</p>
        ...
        <p>Reflo Hub  only steps in when a formal dispute is brought up by one of the parties. Our involvement is solely for mediation purposes and does not ensure that a resolution will be reached.</p>
    ...
    },
    {
      ...
      content: `
        ...
        <ul class="list-disc pl-5 space-y-2">
          ...
          <li>Before accepting leads, Reflo Hub 's internal communications must properly explain the commission terms.</li>
    ...
    },
    {
      ...
      content: `
        <p>To preserve Reflo Hub .'s worth and integrity:</p>
        <ul class="list-disc pl-5 space-y-2">
    ...
    },
    {
      ...
      content: `
        <p>Copyright and intellectual property laws safeguard all of Reflo Hub 's software, trademarks, logos, graphics, and content. Without our express written consent, you are not permitted to distribute, sell, lease, copy, alter, or otherwise use our content.</p>
      `,
    },
    {
      title: 'Compliance & International Use',
      content: `
        <p>Reflo Hub  is accessible worldwide and is run out of Canada. Users are required to abide by local laws that are relevant to their regions.</p>
      `,
    },
    {
    ...
    },
    {
      title: 'Disclaimers',
      content: `
        <p>REFLO HUB  IS GIVEN "AS IS" WITHOUT ANY KIND OF WARRANTY. ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES CAUSED BY USE OF THE PLATFORM ARE NOT OUR LIABILITY.</p>
      `,
    },
    {
    ...
    <section className="relative min-h-screen bg-white dark:bg-gray-950 text-gray-900 dark:text-white overflow-hidden perspective-1000 font-sans">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-16 lg:py-24">
        ...
        <motion.div variants={sectionVariants} initial="hidden" animate="visible" className="max-w-4xl mx-auto">
          <p className="text-gray-500 dark:text-gray-400 mb-6">Effective Date: 2025-07-01 | Last Updated: 2025-07-01</p>
