      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-16 lg:py-24">
        ...
        >
          ...
          >
            ...
            <span className="text-sm font-medium text-gray-100">Terms & Conditions</span>
          </motion.div>
        ...
        <motion.div variants={sectionVariants} initial="hidden" animate="visible" className="max-w-4xl mx-auto">
          <p className="text-gray-400 mb-6">Effective Date: [Insert Date] | Last Updated: [Insert Date]</p>
