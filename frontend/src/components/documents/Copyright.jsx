...
const Copyright = () => {
  ...
  const copyrightSections = [
    ...
    },
    {
      ...
      content: `
        <p>Intellectual property rights are respected by Reflo Hub Ltd. Please contact us straight away at: <a href="mailto:legal@reflohubltd.com" class="text-cyan-400 hover:underline">legal@reflohubltd.com</a> if you think your copyrighted material has been misused or violated on our site.</p>
    ...
    },
    {
      ...
      content: `
        ...
        <p><strong>Email:</strong> <a href="mailto:legal@reflohubltd.com" class="text-cyan-400 hover:underline">legal@reflohubltd.com</a></p>
